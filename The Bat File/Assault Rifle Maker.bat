...
echo 	"ammo_pool_type"								"bullet"                                                      >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
...
if "%Advanced%"=="no" (goto No1)                                                                                        
:Yes1                                                                                                                    
echo 	"viewmodel"   									"%ViewModel%"                                                 >> output\mp_weapon_%Name%.txt
echo 	"playermodel" 									"%PlayerModel%"                                               >> output\mp_weapon_%Name%.txt
goto After                                                                                                            >> output\mp_weapon_%Name%.txt
:No1                                                                                                                     output\mp_weapon_%Name%.txt
...
:After                                                                                                                   output\mp_weapon_%Name%.txt
...
goto after5                                                                                                           >> output\mp_weapon_%Name%.txt
:Nope3                                                                                                                   output\mp_weapon_%Name%.txt
	"fire_sound_1_player_1p"						"Weapon_bulletCasings.Bounce">> mp_weapon_%name%.txt              >> output\mp_weapon_%Name%.txt
	"fire_sound_1_player_3p"						"Weapon_bulletCasings.Bounce">> mp_weapon_%name%.txt              >> output\mp_weapon_%Name%.txt
	"fire_sound_2_player_1p"						"Weapon_r101_SecondShot_1P">> mp_weapon_%name%.txt                >> output\mp_weapon_%Name%.txt
	"fire_sound_2_player_3p"						"">> mp_weapon_%name%.txt                                         >> output\mp_weapon_%Name%.txt
	"fire_sound_2_npc"								"Weapon_r101_SecondShot_NPC" >> mp_weapon_%name%.txt              >> output\mp_weapon_%Name%.txt
	"sound_dryfire"									"assault_rifle_dryfire">> mp_weapon_%name%.txt                    >> output\mp_weapon_%Name%.txt
	"sound_zoom_in"									"Weapon_r101_ADS_In">> mp_weapon_%name%.txt                       >> output\mp_weapon_%Name%.txt
	"sound_zoom_out"								"Weapon_r101_ADS_Out">> mp_weapon_%name%.txt                      >> output\mp_weapon_%Name%.txt
																													  >> output\mp_weapon_%Name%.txt
:After5                                                                                                                  output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
echo     "ammo_clip_size"   								"%AmmoTotal%"                                             >> output\mp_weapon_%Name%.txt
echo     "ammo_default_total"							"%AmmoTotal%"                                                 >> output\mp_weapon_%Name%.txt
echo     "ammo_stockpile_max"							"%AmmoStockPile%"                                             >> output\mp_weapon_%Name%.txt
echo     "ammo_no_remove_from_stockpile"					"1"                                                       >> output\mp_weapon_%Name%.txt
echo     "ammo_min_to_fire"								"%MinFire%"                                                   >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
...
echo             "low_ammo_fraction" 							"0.3"                                                 >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
...
echo 		{                                                                                                         >> output\mp_weapon_%Name%.txt
echo 			"ammo_clip_size" 					"20"                                                              >> output\mp_weapon_%Name%.txt
echo 		}                                                                                                         >> output\mp_weapon_%Name%.txt
echo 		bullets_mag_l2                                                                                            >> output\mp_weapon_%Name%.txt
echo 		{                                                                                                         >> output\mp_weapon_%Name%.txt
echo 			"ammo_clip_size" 					"25"                                                              >> output\mp_weapon_%Name%.txt
echo 		}                                                                                                         >> output\mp_weapon_%Name%.txt
echo 		bullets_mag_l3                                                                                            >> output\mp_weapon_%Name%.txt
echo 		{                                                                                                         >> output\mp_weapon_%Name%.txt
echo 			"ammo_clip_size" 					"28"                                                              >> output\mp_weapon_%Name%.txt
echo 		}                                                                                                         >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
echo.                                                                                                                 >> output\mp_weapon_%Name%.txt
...
echo If you use JANU's Framework 2.0 you do not need to map spawn or use the dev menu! >> output\mapspawn_and_dev_menu.txt
